...
#define STRING_CONFIG_H_AUTHOR "(bobblejot, fr3d i3 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "fr3d i3"
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 1.75   // (mm) Diameter of the filament generally used (3.0 or 1.75mm), also used in the slicer. Used to validate sensor reading.
  ...
  #define MEASURED_UPPER_LIMIT         2.15 // (mm) Upper limit used to validate sensor reading
  #define MEASURED_LOWER_LIMIT         1.40 // (mm) Lower limit used to validate sensor reading
